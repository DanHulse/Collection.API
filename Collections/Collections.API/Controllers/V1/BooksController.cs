...
namespace Collections.API.Controllers.V1
{
    ...
    public class BooksController : DataController<IBookModel, BookModel, BookDetailViewModel>
    {
        /// <summary>
        ...
        [Route("")]
        [ResponseType(typeof(IHttpActionResult))]
        public override Task<IHttpActionResult> PostAsync([FromBody] IEnumerable<BookModel> model) { return base.PostAsync(model); }
        ...
        [Route("{id}")]
        [ResponseType(typeof(IHttpActionResult))]
        public override Task<IHttpActionResult> PutAsync([FromUri] string id, [FromBody] BookModel model) { return base.PutAsync(id, model); }
