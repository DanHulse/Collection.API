...
namespace Collections.API.Controllers.V1
{
    ...
    public class MoviesController : DataController<IMovieModel, MovieModel, MovieDetailViewModel>
    {
        ...
        [Route("")]
        [ResponseType(typeof(IHttpActionResult))]
        public override Task<IHttpActionResult> PostAsync([FromBody] IEnumerable<MovieModel> model) { return base.PostAsync(model); }
        ...
        [Route("{id}")]
        [ResponseType(typeof(IHttpActionResult))]
        public override Task<IHttpActionResult> PutAsync([FromUri] string id, [FromBody] MovieModel model) { return base.PutAsync(id, model); }
