...
namespace Collections.API.Controllers.V1
{
    ...
    /// </summary>
    /// <seealso cref="Collections.API.Controllers.V1.CollectionsController{VideoGameModel, IVideoGameModel, VideoGameViewModel, VideoGameDetailViewModel}" />
    public class VideoGamesController : CollectionsController<VideoGameModel, IVideoGameModel, VideoGameViewModel, VideoGameDetailViewModel>
    {
        /// <summary>
        ...
        [HttpGet]
        [Route("")]
        [Produces(typeof(IEnumerable<VideoGameViewModel>))]
        ...
        [HttpGet]
        [Route("{id}")]
        [Produces(typeof(VideoGameDetailViewModel))]
        ...
        [Route("search")]
        [Produces(typeof(IEnumerable<VideoGameViewModel>))]
        public override async Task<IActionResult> PostSearchAsync([FromBody]VideoGameModel model) { return await base.PostSearchAsync(model); }
        ...
        public override async Task<IActionResult> PostAsync([FromBody]IEnumerable<VideoGameModel> model) { return await base.PostAsync(model); }
        ...
        [Route("{id}")]
        [Produces(typeof(IActionResult))]
        public override async Task<IActionResult> PatchAsync([FromRoute]string id, [FromBody]VideoGameModel model) { return await base.PatchAsync(id, model); }
